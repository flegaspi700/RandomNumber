...
#line hidden
            {
#line 14 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
                var q = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 16 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(q);
#line 19 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
...
#line hidden
    ...
    [SourceLocation("C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs", OperationFunctor.Body, 37, 53)]
    public partial class SampleRandomNumberInRange : Operation<(Int64,Int64), Int64>, ICallable
    {
        ...
        {
            var (max,min) = __in__;
#line 38 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
            var output = 0L;
#line 39 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
            while (true)
            {
#line 40 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
                var bits = QArray<Result>.Create(0L);
#line 41 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
                foreach (var idxBit in new QRange(1L, Microsoft__Quantum__Math__BitSizeI.Apply(max)))
#line hidden
                {
#line 42 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
                    bits = QArray<Result>.Add(bits, new QArray<Result>(GenerateRandomBit__.Apply(QVoid.Instance)));
                }

#line 44 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
...
#line 46 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
            return output;
        }
    ...
    [SourceLocation("C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs", OperationFunctor.Body, 53, -1)]
    public partial class SampleRandomNumber : Operation<QVoid, Int64>, ICallable
    {
        ...
        {
#line 54 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
            var max = 50L;
#line 55 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
            var min = 10L;
#line 56 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
            Message__.Apply(String.Format("Sampling a random number between {0} and {1}: ", min, max));
#line 57 "C:\\Users\\cttin\\OneDrive\\Documents\\Portfolio\\Qsharp\\RandomNumber\\Program.qs"
            return SampleRandomNumberInRange__.Apply((max, min));
        }
